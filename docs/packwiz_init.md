...
```
  ...
  -l, --latest                      Automatically select the latest version of Minecraft
      ...
      --loader string               The pack loader to use: modrinth or curseforge (omit to define interactively)
      --mc-version string           The Minecraft version to use (omit to define interactively)
      --modlist                     Create and maintain a modlist.md file in the pack root
