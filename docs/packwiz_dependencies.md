## packwiz dependencies

Manage and view the dependency tree for the modpack

```
packwiz dependencies [flags]
```
...
* [packwiz dependencies generate](packwiz_dependencies_generate.md)	 - Generate or update dependencies.toml and track it in index.toml
